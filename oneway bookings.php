...
if($ClassName =='Business'){
	$sql="SELECT P.UName ,FL.FLIGHT_NO, FL.FROM_DATE, FL.DEPART_AIRPORT, FL.TO_AIRPORT, FL.DEPART_TIME, C.CLASS_NAME, C.CAPACITY, C.PRICE,AR.FLIGHT_NAME,AR.B_CAPACITY FROM passenger P,airplane AR, oneway FL,class C WHERE  P.UName='$UserName' AND C.CLASS_NAME= 'Business' AND C.FLIGHT_NO = '$FlightNO' AND  FL.FLIGHT_NO = ' $FlightNO ' AND AR.FLIGHT_NO='$FlightNO'";
...
$query=mysqli_query($link,$sql);
 ...
 if(mysqli_num_rows($query) ==1){
	$row = $query->fetch_assoc();
       ...
       $sql2 = "INSERT INTO my_bookings VALUES('$FlightNO','$UserName','$DepartureAirport', '$ArrivalAirport','$Departuredate','0000-00-00','$Departuretime', '$Flighttype','$Classname','$price')";
...
$sql="SELECT P.UName ,FL.FLIGHT_NO, FL.FROM_DATE, FL.DEPART_AIRPORT, FL.TO_AIRPORT, FL.DEPART_TIME, C.CLASS_NAME, C.CAPACITY, C.PRICE,AR.FLIGHT_NAME,AR.E_CAPACITY FROM passenger P,airplane AR, oneway FL,class C WHERE  P.UName='$UserName' AND C.CLASS_NAME= 'Economy' AND C.FLIGHT_NO = '$FlightNO' AND  FL.FLIGHT_NO = '$FlightNO' AND AR.FLIGHT_NO='$FlightNO'";
